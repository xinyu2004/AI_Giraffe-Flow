...
Vendor checkout / generated source trees go under [`middleware/third_party/`](../middleware/third_party/) (attr/acl/**cpptoml** staging: `middleware/.deps-prefix/`). iceoryx must **not** `DOWNLOAD_TOML_LIB` into SKU `build-*/dependencies/`. This directory remains the **source of truth for “what we depend on”**.
