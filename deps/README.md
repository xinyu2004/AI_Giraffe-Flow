...
Vendor checkout / generated source trees go under [`../third_party/`](../third_party/) once implementation starts. Until then this directory is the **source of truth for “what we depend on”**.
