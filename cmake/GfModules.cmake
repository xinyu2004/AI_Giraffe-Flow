...
if(TARGET gf_ara_diag AND TARGET gf_ara_ucm AND TARGET gf_ara_sm AND TARGET gf_ara_collector)
  if(NOT TARGET gf_doip_ota_server)
    ...
    if(DEFINED GF_GENERATED_DIR)
      target_include_directories(gf_doip_ota_server PRIVATE "${GF_GENERATED_DIR}/include")
      if(EXISTS "${GF_GENERATED_DIR}/include/gf_gen/deploy_config.hpp")
        target_compile_definitions(gf_doip_ota_server PRIVATE GF_HAS_DEPLOY_CONFIG=1)
      endif()
      if(EXISTS "${GF_GENERATED_DIR}/include/gf_gen/collector_config.hpp")
        target_compile_definitions(gf_doip_ota_server PRIVATE GF_HAS_COLLECTOR_CONFIG=1)
      endif()
      if(EXISTS "${GF_GENERATED_DIR}/include/gf_gen/bounds_config.hpp")
        target_compile_definitions(gf_doip_ota_server PRIVATE GF_HAS_BOUNDS_CONFIG=1)
      endif()
      if(EXISTS "${GF_GENERATED_DIR}/include/gf_gen/ucm_config.hpp")
        target_compile_definitions(gf_doip_ota_server PRIVATE GF_HAS_UCM_CONFIG=1)
      endif()
      if(EXISTS "${GF_GENERATED_DIR}/include/gf_gen/diag_seed.hpp")
        target_compile_definitions(gf_doip_ota_server PRIVATE GF_HAS_DIAG_SEED=1)
      endif()
    endif()
  endif()
