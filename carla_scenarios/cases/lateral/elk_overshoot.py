#!/usr/bin/env python3
"""Emergency lane keep — overshoot + neighbor"""
...
from layouts.lateral import layout_elk_overshoot, tick_lateral_handoff  # noqa: E402
from judges.controlled import judge_lateral  # noqa: E402

CASE = AtomCase(
    tag="elk_overshoot",
    layout=layout_elk_overshoot,
