...
from layouts.lateral import layout_lcc_straight, tick_lateral_handoff  # noqa: E402
from judges.controlled import judge_lateral  # noqa: E402

CASE = AtomCase(
    tag="lcc_straight",
    layout=layout_lcc_straight,
