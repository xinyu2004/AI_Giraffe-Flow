#!/usr/bin/env python3
"""Traffic sign — speed limit visible"""
...
from layouts.perception import layout_tsr_speed_limit, tick_perception_handoff  # noqa: E402
from judges.controlled import judge_env  # noqa: E402

CASE = AtomCase(
    tag="tsr_speed_limit",
    layout=layout_tsr_speed_limit,
    judge=lambda samples, seen, meta: judge_env(samples, seen_control=seen),
    weather_preset="clear",
    early_exit_on_collision=False,
    on_tick=tick_perception_handoff,
    title="AFC tsr_speed_limit",
)
