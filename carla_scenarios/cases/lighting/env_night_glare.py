#!/usr/bin/env python3
"""Night — oncoming high beam glare"""
...
from layouts.lighting import layout_night_glare, tick_light_handoff  # noqa: E402
from judges.controlled import judge_env  # noqa: E402

CASE = AtomCase(
    tag="env_night_glare",
    layout=layout_night_glare,
