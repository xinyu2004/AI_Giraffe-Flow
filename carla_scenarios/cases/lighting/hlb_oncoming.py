#!/usr/bin/env python3
"""High/low beam — oncoming vehicle"""
...
from layouts.lighting import layout_hlb_oncoming, tick_light_handoff  # noqa: E402
from judges.controlled import judge_env  # noqa: E402

CASE = AtomCase(
    tag="hlb_oncoming",
    layout=layout_hlb_oncoming,
