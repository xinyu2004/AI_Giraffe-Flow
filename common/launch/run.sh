...
#
# Config truth = gf-config Verify(+Generate) → generated/observability.json + build binaries.
...
#
# Product entry on a staged runtime/: bin/giraffe_launch （EM；与板端/主机调试同口径）
# GMT extras: scripts/GMT_depend_launch.sh （由本脚本默认挂上）
set -euo pipefail
