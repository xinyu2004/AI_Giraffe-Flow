...
export GF_BUILD_DIR="${GF_BUILD_DIR:-${ROOT}/projects/afc/build-sil}"
...
run(
    "bash projects/afc/scripts/verify/run_sil_verify.sh",
...
run("bash projects/afc/scripts/verify/smoke_sil_phm_fault.sh")
...
run("bash projects/afc/scripts/verify/smoke_sil_em_daemon.sh")
