...
### SIL-01 — 双进程 demo
- 类别: fusa
- 脚本: `projects/oem_a/afc_with_uss/scripts/verify/smoke_sil.sh`
- 前置: deps bootstrap
...
- 类别: fusa
- 脚本: `projects/oem_a/afc_with_uss/scripts/verify/smoke_sil_verify.sh`
...
- 类别: fusa
- 脚本: `projects/oem_a/afc_with_uss/scripts/verify/smoke_sil_phm_fault.sh`
...
- 类别: fusa
- 脚本: `projects/oem_a/afc_with_uss/scripts/verify/smoke_sil_sm_fg.sh`
...
- 脚本: `projects/oem_a/afc_with_uss/scripts/verify/smoke_production_profile.sh`
...
- 类别: fusa
- 脚本: `projects/oem_b/adc_full/scripts/verify/smoke_mcu_desktop.sh`
...
- SIL: `projects/oem_a/afc_with_uss/scripts/verify/smoke_sil_em_daemon.sh`
...
- 类别: debug-path
- 脚本: `projects/oem_a/afc_with_uss/scripts/verify/smoke_sil_observability.sh`
