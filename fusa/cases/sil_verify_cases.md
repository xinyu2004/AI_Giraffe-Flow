...
### SIL-01 — 双进程 demo
- 类别: fusa
- 脚本: `projects/afc/scripts/verify/smoke_sil.sh`
- 前置: deps bootstrap
...
- 脚本: `projects/afc/scripts/verify/smoke_production_profile.sh`
...
- 类别: fusa
- 脚本: `projects/adc/scripts/verify/smoke_mcu_desktop.sh`
...
- 类别: debug-path
- 脚本: `projects/afc/scripts/verify/smoke_sil_observability.sh`
