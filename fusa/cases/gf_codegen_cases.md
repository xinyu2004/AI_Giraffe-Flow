...
| Case ID | 意图 | 复现 | 状态 |
|---------|------|------|------|
| CG-01 | compose afc → sku cmake / observability | `pytest tools/gf-codegen/tests/test_compose_afc.py tools/gf-codegen/tests/test_observability.py -q` | active |
...
| CG-04 | 生成代码进 SIL 可链接 | `bash projects/afc/scripts/compile_sil.sh`（与 L3 交叉） | active |
